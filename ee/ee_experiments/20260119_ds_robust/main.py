...
def main():
    ...
    train_ds_str = ["cifar10_train", "stl10_train", "tiny-imagenet_train", "caltech101_trainval", "cub200_train", "flowers102_train", "oxford-pet_trainval", "mnist_train", "fashion-mnist_train", "svhn_train", "cifar100_train"]
    val_ds_str = ["cifar10_val", "stl10_val", "tiny-imagenet_val", "caltech101_trainval", "cub200_val", "flowers102_val", "oxford-pet_val", "mnist_val", "fashion-mnist_val", "svhn_val", "cifar100_val"]
