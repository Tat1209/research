...
def main():
    ...
    train_ds_str = ["tiny-imagenet_train", "caltech101_labeled", "cub200_train", "flowers102_train", "oxford-pet_train", "mnist_train", "fashion-mnist_train", "svhn_train", "cifar100_train", "cifar10_train"]
    val_ds_str = ["tiny-imagenet_test", "caltech101_labeled", "cub200_test", "flowers102_test", "oxford-pet_test", "mnist_test", "fashion-mnist_test", "svhn_test", "cifar100_test", "cifar10_test"]
    batch_size = [128, 32, 32, 32, 32, 128, 128, 128, 128, 128]
