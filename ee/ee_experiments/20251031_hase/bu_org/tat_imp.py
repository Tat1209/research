...
network = Network(resnet18_cifar_ee(num_classes=100, channels=16, ensembles=16))

network.torchinfo(input_size=(1, 3, 32, 32), output_path=this_path.parent / "tat_arc.txt")