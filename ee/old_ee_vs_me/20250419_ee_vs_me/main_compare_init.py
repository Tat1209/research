...
for net in [gitnet_bn]:
    for i in range(2):
        ...
        for e in range(epochs):
            ...
            trainer.printmet(met_dict, e + 1, epochs)
        ...
        for e in range(epochs):
            ...
            etrainer.printmet(met_dict, e + 1, epochs)
            run_mgr.log_metrics(met_dict, step=e + 1)
