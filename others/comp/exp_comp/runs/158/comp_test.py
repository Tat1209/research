...
train_trans = [transforms.ToImage(), transforms.CenterCrop(85), transforms.RandomHorizontalFlip(), transforms.RandomRotation(degrees=180, fill=(0, 0, 0)), transforms.ToDtype(torch.float32, scale=True), normalize]
